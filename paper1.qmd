...
Data used come from the Open Data Toronto Portal through the library `opendatatoronto` (Gelfand, 2022). Data were cleaned and analyzed using the open source statistical programming language R (R Core Team, 2023). Libraries `tidyverse` (Wickham et al., 2019), `janitor` (Firke, 2023), `knitr` (Xie, 2023), `dplyr` (Wickham, 2022), and 'lubridate' (Grolemund, 2011) were used for simulating, cleaning, running tests and creating graphics for the project.
...
merged_ward_fires |>
  ...
  geom_point() +
  labs(title = "Civilian fire deaths by ward income, 2018-2022",
